...
var STRINGS = {
  da: {
    ...
    showNameHint: 'Du kan ændre dette senere, når du er logget ind. Hvert indsendt spil giver en notifikation i Discords #general-chat-kanal. Hvis du viser dit navn, bliver det et klikbart @-link uden at pinge dig.',
  ...
  en: {
    ...
    showNameHint: 'You can change this later while you are logged in. Each submitted game is announced in Discord’s #general-chat channel. If you show your name, it becomes a clickable @ link without pinging you.',
